...
public class ArenaServerTarget : TargetRules
{
    public ArenaServerTarget(TargetInfo Target) : base(Target)
    {
        Type = TargetType.Server; // Should be server? Idk why Doesnt work
        bUsesSteam = true;
